...
...$.*....
.664.598..";
        var inputGrid = @".......................153..988....502..842.........588.....441.468......481..........314...715.57............................163..992..512.
............805............*......#.............%...............*........=......%......................#......*.............-....#....*.....
...
.......................716...........551.631........................279..555.....373...................691......114.215............515......";
        ...
        var debug = false;
        var grid = debug ? exampleGrid.Split("\n", StringSplitOptions.TrimEntries) : inputGrid.Split("\n", StringSplitOptions.TrimEntries);
        var gridWidth = grid[0].Length;
        var gridHeight = grid.Length;
        var sumOfMachineParts = 0;

        for (int line = 0; line < gridHeight; line++)
        {
            for (int charIndex = 0; charIndex < gridWidth; charIndex++)
            {
                var ch = grid[line][charIndex];
                ...
                {
                    IO.Write(ch.ToString());
                }
                else
                {
                    // real stuff
                    // Could search around this character instead of the other way around searching around numbers...
                    // sweep around char and delete nums from array (replace with ... for example)
                    // IO.Write(ch.ToString());
                    // for each direction see if there is a number and if there is add and delete the number
                    // special characters are always inside the grid and not on the perimeter
                    for (int i = line - 1; i < line + 2; i++)
                    {
                        for (int j = charIndex - 1; j < charIndex + 2; j++)
                        {
                            AddToSumAndDeleteFromGrid(i, j);
                        }
                    }
                }
            }
        ...
        // find out whole number, add and delete it
        void AddToSumAndDeleteFromGrid(int line, int symbol)
        {
            if (IsNumber(grid[line][symbol]))
            {
                // find out start and end index by going left and right from current symbol
                var numberStartIndex = symbol;
                var numberEndIndex = symbol;

                for (int i = symbol; ; i++)
                {
                    if (OutOfBounds(line, i))
                    {
                        break;
                    }

                    if (!IsNumber(grid[line][i]))
                    {
                        break;
                    }
                    else
                ...
                var num = int.Parse(grid[line][numberStartIndex..(numberEndIndex + 1)]);
                sumOfMachineParts += num;
                // IO.Print("found Num: " + num);

                var lineWithoutNumber = "";
                for (int i = 0; i < gridWidth; i++)
                {
                    if (i >= numberStartIndex && i <= numberEndIndex)
                    {
                        lineWithoutNumber += '.';
                    }
                    else
                    {
                        lineWithoutNumber += grid[line][i];
                    }
                }

                grid[line] = lineWithoutNumber;
                IO.Print(lineWithoutNumber);
            }
        }

        bool OutOfBounds(int line, int column)
        {
            return !(line >= 0 && line < gridWidth && column >= 0 && column < gridHeight);
        }

        IO.Print(nameof(sumOfMachineParts) + " " + sumOfMachineParts);
    }

    // * = gear, multiply two numbers it touches
    public void Part2()
    {
        var exampleGrid = @"467..114..
...*......
...
.......................716...........551.631........................279..555.....373...................691......114.215............515......";
        ...
        List<int> gearNeighbourNumbers = new();
        ...
        for (int line = 0; line < gridHeight; line++)
        {
            for (int charIndex = 0; charIndex < gridWidth; charIndex++)
            {
                ...
                {
                    gearNeighbourNumbers.Clear();
                    // sweep around char and delete nums from array (replace with ...)
                    // IO.Write(ch.ToString());
                    // for each direction see if there is a number and if there is add and delete the number
                    // special characters are always inside the grid and not on the perimeter
                    for (int i = line - 1; i < line + 2; i++)
                    {
                        for (int j = charIndex - 1; j < charIndex + 2; j++)
                        {
                            AddToGearNeighboursAndDeleteFromGrid(i, j);
                        }
                    }
                    if (gearNeighbourNumbers.Count == 2)
                    {
                        sumOfGearRatios += gearNeighbourNumbers[0] * gearNeighbourNumbers[1];
                    }
                }
            }
            // IO.Print("");
        ...
        // find out whole number, add and delete it
        void AddToGearNeighboursAndDeleteFromGrid(int line, int symbol)
        {
            if (IsNumber(grid[line][symbol]))
            {
                // find out start and end index by going left and right from current symbol
                ...
                var num = int.Parse(grid[line][numberStartIndex..(numberEndIndex + 1)]);
                // sumOfGearRatios += num;
                if (!gearNeighbourNumbers.Contains(num))
                {
                    gearNeighbourNumbers.Add(num);
                }
                // IO.Print("found Num: " + num);
        ...
        IO.Print(nameof(sumOfGearRatios) + " " + sumOfGearRatios);
    }
}